 ...
 *
 * Concrete implementations adapt different REST API schemas (Gemini, OpenAI, Claude, DeepSeek)
 * into a single unified JSON string format for downstream domain mappers.
 */
interface IAiProviderAdapter {
     ...
     * @param systemInstruction Prompt instructions defining Nagpur/Indian portion context & JSON schema requirements.
     ...
     */
    suspend fun parseMeal(inputText: String, apiKey: String, systemInstruction: String, modelName: String = ""): String
}
