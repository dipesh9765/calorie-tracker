...
/**
 * Enterprise Preferences Repository providing persistent local storage for User Profile,
 * API Keys, custom AI model configurations, and target macro goals using SharedPreferences.
 */
