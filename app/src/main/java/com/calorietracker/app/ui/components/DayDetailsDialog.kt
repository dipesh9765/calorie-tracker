...
/**
 * Enterprise Modal Dialog displaying complete breakdown of meals eaten on a specific day,
 * along with combined total calories and macronutrient statistics.
 */
@Composable
fun DayDetailsDialog(
    summary: DailySummary,
    dayMeals: List<MealEntry>,
    onDismiss: () -> Unit
) {
    AlertDialog(
                            ...
                            Row(
                                ...
                                Column {
                                    ...
                                    Text(
                                        ...
                                        color = if (summary.totalCalories <= summary.targetCalories) AccentEmerald else AccentOrange,
                                        fontWeight = FontWeight.Bold,
                                        fontSize = 15.sp
                                    )
                                }
