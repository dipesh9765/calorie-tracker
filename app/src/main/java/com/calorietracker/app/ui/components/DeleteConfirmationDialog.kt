...
/**
 * Enterprise Delete Confirmation Dialog. Prompts the user for explicit confirmation before deleting
 * any logged meal entry.
 */
@Composable
fun DeleteConfirmationDialog(
  ...
  AlertDialog(
    ...
    text = {
      Text(
        text =
          "Are you sure you want to delete \"$foodName\" logged for $dateIso? Your daily calories and macro totals will be updated automatically.",
        color = TextSecondary,
        fontSize = 14.sp
      )
    },
