...
class NutritionCalculator {
  ...
  /**
   * Mifflin-St Jeor Equation: Men: BMR = (10 × weight in kg) + (6.25 × height in cm) - (5 × age in
   * years) + 5 Women: BMR = (10 × weight in kg) + (6.25 × height in cm) - (5 × age in years) - 161
   */
  ...
  /** TDEE Activity Multipliers: Sedentary / Office job + Gym 4-5 days = 1.375 - 1.4 */
