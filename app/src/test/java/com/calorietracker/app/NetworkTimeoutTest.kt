...
/**
 * Production Test Suite verifying network timeout handling, user-friendly error transformation, and
 * connection failure recovery across AI nutrition repositories.
 */
class NetworkTimeoutTest {

  @Test
  fun `repository handles SocketTimeoutException gracefully with user-friendly error message`() =
    runBlocking {
      val timingOutAdapter =
      ...
      val result =
        repository.parseMealText("Yesterday I ate 2 rotis", AiProviderType.GEMINI, "valid_key")
      ...
      assertTrue(
        "Error message should mention timeout and provider name, but was: $errorMessage",
